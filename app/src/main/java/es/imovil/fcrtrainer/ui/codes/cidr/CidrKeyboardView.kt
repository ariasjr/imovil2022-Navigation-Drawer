...
class CidrKeyboardView(context: Context?, attributeSet: AttributeSet) : LinearLayout(context, attributeSet), View.OnClickListener {

    private var mEditText: EditText? = null // this receives the keystrokes

    private fun getLayoutId(): Int {
        return R.layout.fragment_cidr_keyboard_view
    }
    ...
    override fun onClick(view: View?) {
        if (mEditText == null) {
            ...
            mEditText = parent.findViewById(R.id.bin_text_view_answer)
