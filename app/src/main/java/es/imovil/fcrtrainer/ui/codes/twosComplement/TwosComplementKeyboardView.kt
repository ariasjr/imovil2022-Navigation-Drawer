...
class TwosComplementKeyboardView(context: Context?, attributeSet: AttributeSet) : LinearLayout(context, attributeSet), View.OnClickListener {

    private var mEditText: EditText? = null // this receives the keystrokes

    private fun getLayoutId(): Int {
        return R.layout.keyboard_twos_complement
    }
    ...
    override fun onClick(view: View?) {
        if (mEditText == null) {
            ...
            mEditText = parent.findViewById(R.id.tcAnswer)
