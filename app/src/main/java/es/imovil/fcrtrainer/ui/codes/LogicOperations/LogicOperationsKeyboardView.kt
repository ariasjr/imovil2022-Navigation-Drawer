...
class LogicOperationsKeyboardView(context: Context?, attributeSet: AttributeSet) : LinearLayout(context, attributeSet), View.OnClickListener {
    ...
    override fun onClick(view: View?) {
        if (mEditText == null) {
            ...
            mEditText = parent.findViewById(R.id.input)
